...
class EmailReporter:
    ...
    def generate_html_report(analysis_result: Dict) -> str:
        ...
        safe_metadata = {
            k: html_lib.escape(str(v)) for k, v in metadata.items()
        }
            ...
            <div class="container">
                ...
                <div class="section">
                    ...
                    <div class="meta-grid">
                        <div class="meta-item">
                            <label>From</label>
                            <span>{safe_metadata.get('sender', 'N/A')}</span>
                        </div>
                        <div class="meta-item">
                            <label>To</label>
                            <span>{safe_metadata.get('recipient', 'N/A')}</span>
                        </div>
                        <div class="meta-item">
                            <label>Subject</label>
                            <span>{safe_metadata.get('subject', 'N/A')}</span>
                        </div>
                        <div class="meta-item">
                            <label>Date</label>
                            <span>{safe_metadata.get('date', 'N/A')}</span>
                        </div>
                    </div>
                </div>
