"""Test for DoS protection in email parser."""
...
class TestEmailParserDoS(unittest.TestCase):
    """Test DoS protection limits in email parser."""
    ...
    def test_gzip_limit(self):
        """Test that gzip files are truncated to size limit."""
        # Create a "large" gzip file: 1000 bytes > 50 bytes limit
    ...
    def test_file_limit(self):
        """Test that plain files are truncated to size limit."""
