# flake8: noqa: E402
"""Test for XSS vulnerability in HTML report generation."""
import unittest
import sys
import os
import html
...
class TestXSS(unittest.TestCase):
    ...
    def test_xss_in_finding(self):
        ...
        # We expect the HTML to contain the ESCAPED version
        self.assertNotIn(
            malicious_filename,
            html_report,
            "Raw malicious payload found in report! XSS Vulnerability detected.",
        )
        self.assertIn(
