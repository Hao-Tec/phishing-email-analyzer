...
class TestTyposquatting(unittest.TestCase):
    ...
    def test_paypal_typosquatting(self):
        ...
        doppelganger_finding = next((f for f in findings if f["heuristic"] == "doppelganger_domain"), None)
        
        self.assertIsNotNone(doppelganger_finding, "Failed to detect 'paypa1.com' as typosquatting of 'paypal.com'")
